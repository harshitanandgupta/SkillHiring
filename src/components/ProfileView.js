        ...
        return (
            <div className="mt-2">
                ...
                <div className="w3-light-grey w3-round-xlarge w3-small mt-2">
                    <div className="w3-container w3-center w3-round-xlarge w3-teal" style={{width:`${item.rating}%`}}>{item.rating}%</div>
                </div>
            </div>
        )
    })
    const empexp=emp.experience.map((item)=>{
        return (
            <div className="w3-container">
                    <h5 className="w3-opacity"><b>{item.name}</b></h5>
        <h6 className="w3-text-teal"><i className="fa fa-calendar fa-fw w3-margin-right"></i>{item.startyear} - {item.endyear}</h6>
    ...
    const emppro=emp.projects.map((item)=>{
        return (
            <div className="w3-container">
                    ...
                    <a href={item.link}><span className="w3-text-blue">{item.link}</span></a>
                    </h6>
                    <p>{item.description}</p>
                    <hr/>
            </div>
            ...
            <div className="w3-row-padding">
                <div className="w3-third">
                    ...
                    <div className="w3-container mt-2">
                        <p><i className="fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-teal"></i>{emp.designation}</p>
                        <p><i className="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i>{emp.address}</p>
                        <p><i className="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i>{emp.email}</p>
                        <p><i className="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i>{emp.phone}</p>
                ...
                <div className="w3-container w3-card w3-white">
                    <h2 className="w3-text-grey w3-padding-16"><i className="fa fa-tasks fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Projects</h2>
                    {emppro}
                </div>
